...
class Proveedor(models.Model):
    """
    Representa una empresa o persona que provee productos.
    """
...
class Carrito(models.Model):
    """
    Representa un carrito de compras temporal de un cliente.
    """
...
class ItemCarrito(models.Model):
    ...
    def subtotal(self):
        """
        Calcula el subtotal del ítem basado en cantidad y precio al momento.
        """
        return self.cantidad * self.precio_al_momento

    def save(self, *args, **kwargs):
        """
        Guarda el precio actual del producto si no se ha definido antes.
        """
...
class Venta(models.Model):
    """
    Representa una venta realizada al cliente.
    """
    TIPO_PAGO_CHOICES = [
        ('efectivo', 'Efectivo'),
        ('tarjeta', 'Tarjeta'),
    ...
    pedido = models.OneToOneField(Pedido, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Pedido Relacionado")
    cliente = models.ForeignKey(Cliente, on_delete=models.RESTRICT, verbose_name="Cliente")
...
class DetalleVenta(models.Model):
    """
    Representa un producto vendido dentro de una venta.
    """
